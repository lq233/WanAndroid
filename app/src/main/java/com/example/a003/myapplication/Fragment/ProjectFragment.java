...
public class ProjectFragment extends Fragment {
    ...
    private com.example.a003.myapplication.Util.StringUtil StringUtil;
            ...
            public void run() {
                ...
                try {
                    ...
                    if (responseCode == 200) {
                        ...
                        String result = com.example.a003.myapplication.Util.StringUtil.stream2String(inputStream);
